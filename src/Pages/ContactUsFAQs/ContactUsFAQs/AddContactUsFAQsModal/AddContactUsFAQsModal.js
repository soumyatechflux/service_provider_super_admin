...
const AddContactUsFAQsModal = ({ show, onClose, onSave, categoryID, fetchFAQs }) => {
  ...
  const handleSave = async () => {
    ...
    try {
      ...
      const response = await axios.post(
        `${process.env.REACT_APP_SERVICE_PROVIDER_SUPER_ADMIN_BASE_API_URL}/api/admin/cms/contact_us_faqs/add`,
        payload,
        {
...
export default AddContactUsFAQsModal;
