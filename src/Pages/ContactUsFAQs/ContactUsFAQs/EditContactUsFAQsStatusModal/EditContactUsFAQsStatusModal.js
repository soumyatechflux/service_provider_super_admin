...
const EditContactUsFAQsStatusModal = ({
  ...
  const handleStatusUpdate = async () => {
    ...
    try {
      ...
      const payload = {
        faq_id: Number(faq?.id),  // Ensure it's a number
      ...
      const response = await axios.patch(
        `${process.env.REACT_APP_SERVICE_PROVIDER_SUPER_ADMIN_BASE_API_URL}/api/admin/cms/contact_us_faqs/status`,  // Adjusted URL endpoint
        payload,
        {
...
export default EditContactUsFAQsStatusModal;
