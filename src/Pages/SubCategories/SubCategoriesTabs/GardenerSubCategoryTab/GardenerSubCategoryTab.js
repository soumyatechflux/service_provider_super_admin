  ...
  const fetchSubCategoryData = async () => {
    try {
      ...
      const response = await axios.get(
        `${process.env.REACT_APP_SERVICE_PROVIDER_SUPER_ADMIN_BASE_API_URL}/api/admin/sub_category_by_category_id/3`,
        {
          headers: {
...
export default GardenerSubCategoryTab;
