...
//             <Text>On behalf of: {customer?.partner_name || "Servyo Partner"}</Text>
...
//           <Text>SAC Code: {customer?.hsn_code || "996412"}</Text>
...
//       qty: 1,
//       amount: customer?.sub_category?.platform_fee,
//     },
//     customer?.igst && {
//       date: customer?.tax_date || 'xxx',
//       description: 'IGST',
...
//           {getFormattedDate(customer?.booking_date_time)}
//         </Text>
